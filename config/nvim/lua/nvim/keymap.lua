...
M.lsp = {
    ...
    diagnostic_hover = { mode = 'n', keys = '<leader>ee', desc = 'Hover error' },
    diagnostic_prev = { mode = 'n', keys = '<leader>ep', desc = 'Show previous diagnostic' },
    diagnostic_next = { mode = 'n', keys = '<leader>en', desc = 'Show next diagnostic' },
