return {
    ...
    config = function()
        ...
        local function map_under_cursor(keys, fn, desc)
            ...
            vim.keymap.set("x", "<leader>" .. uppered, fn, { desc = desc })
        ...
        map_under_cursor("fbb", builtin.buffers, "Find buffer")
        ...
        map_under_cursor("ff", builtin.find_files, "Find files")
        map_under_cursor("fkf", builtin.git_files, "Find git files")
        map_under_cursor("fkb", builtin.git_branches, "Find git branch")
        map_under_cursor("fg", builtin.live_grep, "Find with grep")
        map_under_cursor("fq", builtin.help_tags, "Find help")
        map_under_cursor("fr", builtin.oldfiles, "Find recent")
        map_under_cursor("fe", builtin.diagnostics, "Find diagnostics")
